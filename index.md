...
![Improved Resource Management](https://github.com/smcclurkin0312/smcclurkin0312.github.io/raw/main/assets/images/Code_Screenshot_Enhancement1_Course_Outcome4.png)
...
![Enhanced Security with Null Safety](https://github.com/smcclurkin0312/smcclurkin0312.github.io/raw/main/assets/images/Code_Screenshot_Enhancement1_Course_Outcome5.png)
...
Additionally, I updated the app to **API level 35**, which ensures that it follows Google’s latest security standards. This update includes **stricter permission handling, stronger encryption policies, and better data protection** (Singh, 2025). By implementing these enhancements, I demonstrated my ability to develop software with a security mindset, anticipate potential vulnerabilities, and design features that help protect user data, fully satisfying the fifth course outcome.
